...
# Mixar Community: empty (Publish to Community disabled) until the service is deployed.
export MIXAR_COMMUNITY_URL="${MIXAR_COMMUNITY_URL:-}"
export MIXAR_COMMUNITY_API_URL="${MIXAR_COMMUNITY_API_URL:-}"
