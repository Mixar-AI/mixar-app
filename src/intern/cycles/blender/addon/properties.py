...
class CyclesRenderSettings(bpy.types.PropertyGroup):
    ...
    device: EnumProperty(
        ...
        items=enum_devices,
        # Mixar: default to GPU rendering. The cycles_gpu bootstrap module
        # enables a compute backend at startup, and Cycles falls back to CPU
        # by itself when none is usable, so 'GPU' is always safe. Scenes
        # saved with an explicit device choice are unaffected (the stored
        # property wins over this default).
        default='GPU',
