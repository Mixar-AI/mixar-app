...
const bTheme U_theme_default = {
  ...
  .space_outliner = {
    ...
    .header_text = RGBA(0xeeeeeeff),
    .header_text_hi = RGBA(0xffffffff),
    .active = RGBA(0x4b4e57ff),
    .vertex_size = 3,
    .outline_width = 1,
    .facedot_size = 4,
    .match = RGBA(0x337f334c),
    .selected_highlight = RGBA(0xe2294fff),
  ...
  .space_mixie_chat = {
    ...
    .chat_bubble_hover = RGBA(0x4dd9f2f2),
    ...
    .chat_placeholder_text = RGBA(0xbebebe00),
    ...
    .chat_send_arrow_color = RGBA(0xffffffff),
