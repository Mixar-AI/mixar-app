...
/* MIXAR: selection-suggestion ghost outline (emits category 2u). */
PUSH_CONSTANT(bool, is_suggested)
...
/* MIXAR: color for suggested-selection (category 2u) ghost outlines. */
PUSH_CONSTANT(float4, suggested_color)
