...
/* Mixar 5.2 port: namespace wrap. The definitions in `editors/mixar_audio`
 * are wrapped too, and a prototype left at global scope beside a
 * blender-scoped definition compiles per-TU and only fails at final link. */
namespace blender {
