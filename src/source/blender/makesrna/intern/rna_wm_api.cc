...
/* Mixar: agent mixed-mode input flag, defined in windowmanager/intern/wm_event_system.cc. */
...
static wmEvent *rna_Window_event_add_simulate(wmWindow *win,
                                              ...
                                              bool hyper)
{
  /* Mixar: also accepted when the agent enabled mixed-mode input (see rna_wm_mixar.cc). */
