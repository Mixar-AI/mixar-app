...
# menu; the 3D viewport header uses the same Mixar Solid/Rendered pills
# as Zen Mode so the surface matches Zen / Cinema chrome instead of a
# stock Blender editor strip. Names match the analytics allowlist.
