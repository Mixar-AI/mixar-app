...
from ..constants import FROZEN_IMAGE_NAME

logger = get_logger(__name__)


def capture_region_still(context, area, region, name=FROZEN_IMAGE_NAME):
    ...
    try:
        ...
        # than the scene camera — that is the whole point, so the override has
        # to name the area and region or it captures whichever viewport
...
def get_image(name=FROZEN_IMAGE_NAME):
    """The live frozen frame, or None."""
