...
| **agent_panel** | Bottom-docked View3D cards for parallel tasks: WindowManager mirror, shared draw/hit/QA geometry, animated entrance and dismissal, wheel/trackpad scrolling; replaces agent_scene_strip |
